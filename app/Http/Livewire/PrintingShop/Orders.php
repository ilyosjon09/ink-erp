...
class Orders extends Component implements Tables\Contracts\HasTable
{
    ...
    protected function getTableColumns(): array
    {
        return [
            ...
            TextColumn::make('printing_method')->label(__('Краска')),
