<x-filament::widget>
    <x-filament::card>
        ...
        <div class="mt-4 text-lg" class="flex items-center space-x-2">
            ...
            <span class="px-2 py-1 rounded-xl font-bold text-sm bg-{{ $this->currentOperDay->closed ? 'danger' : 'success'}}-500/10 text-{{ $this->currentOperDay->closed ? 'danger' : 'success'}}-700">{{
